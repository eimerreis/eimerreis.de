    ...
    <Layout>
      ...
      <div className="pt-4 pb-12">
        ...
        <h3 className="w-full text-center text-xl py-2">
          Trying to break out of my filter bubble I started creating monthly playlists containing everything from fresh finds, tracks I re-discovered or songs I just discovered after their hype
        </h3>
      </div>
      <ul className="w-full">
